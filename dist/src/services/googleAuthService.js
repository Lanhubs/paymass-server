...
export class GoogleAuthService {
    static GOOGLE_OAUTH_URL = 'https://oauth2.googleapis.com/token';
    static GOOGLE_USERINFO_URL = 'https://www.googleapis.com/oauth2/v2/userinfo';
    static CLIENT_ID = process.env.GOOGLE_CLIENT_ID;
    static CLIENT_SECRET = process.env.GOOGLE_CLIENT_SECRET;
    static REDIRECT_URI = process.env.GOOGLE_REDIRECT_URI || 'http://localhost:3000/api/auth/google/callback';
    /**
