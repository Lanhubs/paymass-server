...
router.post('/login', generalRateLimit, sanitizeInput, [
    body('email')
        .isEmail()
        .withMessage('Valid email is required'),
    body('password')
...
router.post('/refresh', generalRateLimit, sanitizeInput, [
    body('refreshToken')
        .notEmpty()
...
router.post('/logout', generalRateLimit, sanitizeInput, [
    body('refreshToken')
        .notEmpty()
        .withMessage('Refresh token is required')
], handleValidationErrors, (async (req, res) => {
...
// Google OAuth routes
router.get('/google', generalRateLimit, (async (req, res) => {
    try {
...
router.post('/google/callback', generalRateLimit, sanitizeInput, [
    body('code')
        .notEmpty()
...
router.get('/me', generalRateLimit, authenticateToken, (async (req, res) => {
    try {
